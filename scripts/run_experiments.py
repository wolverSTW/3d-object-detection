#!/usr/bin/env python3
"""Run the baseline and geometry-guided experiments together and save a comparison summary."""
...
def parse_args():
    parser = argparse.ArgumentParser(description='Run baseline and geometry experiments and compare results.')
